...
<script>
    ...
    document.addEventListener('scroll', ()=>{
        ...
        if(progress == 100)
        {
            navProgress.classList.add("bg-orange-500")
            navProgress.classList.remove("bg-accent-500")
        }
        else 
        {
            navProgress.classList.add("bg-accent-500")
            navProgress.classList.remove("bg-orange-500")
        }

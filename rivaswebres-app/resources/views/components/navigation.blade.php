<nav class="fixed top-0 z-20 hidden w-full h-screen transition-all duration-300 delay-150 shadow-md opacity-0 hover:shadow-xl md:h-20 bg-slate-200/50 md:block md:opacity-100 backdrop-blur-md" id="nav-bar">

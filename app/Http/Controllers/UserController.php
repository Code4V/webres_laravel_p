...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $information = [
            "socials" =>
            [
                ["socialLink" => "https://www.github.com/Code4V", "socialName" => "Github", "socialIcon" => "fa-github"],
                ["socialLink" => "https://www.facebook.com/vashrivas", "socialName" => "Facebook", "socialIcon" => "fa-facebook"],
                ["socialLink" => "https://www.linkedin.com/in/rivas-jeanne-francis-015750285/", "socialName" => "LinkedIn", "socialIcon" => "fa-linkedin"],
            ],
            "skills" =>
            [
                "front_end" =>
